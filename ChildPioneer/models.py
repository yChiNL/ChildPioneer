...
class CustomUser(AbstractUser):
    ...
    therapists = models.ManyToManyField('self', blank=True, related_name='therapist_friends', symmetrical=False)
    ...
    background_images = models.ManyToManyField(BackgroundImage, blank=True, symmetrical=False)  # 使用 ManyToManyField 来关联用户和背景图片
    # 添加其他必要的字段
    def __str__(self):
