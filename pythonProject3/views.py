...
from pythonProject3.models import CustomUser, TrainingOneFoot, TrainingJump, TrainingWalkStraight, TrainingDance, \
    TreatmentContent,User_BackgroundImage
from pythonProject3.forms import LoginForm, TherapistProfileUpdateForm
from pythonProject3 import settings
...
def dance_view(request, difficulty, frequency, id):
    from pythonProject3.dance import main as dance_Ther
    if request.method == 'POST':
        id = id
        user = request.user
...
def onefoot_therapist_view(request, difficulty, frequency, id):
    from pythonProject3.onefoot import main as onefoot_Ther
    if request.method == 'POST':
        id = id
        user = request.user
        difficulty = difficulty
...
def jump_therapist_view(request, difficulty,  frequency, id):
    from pythonProject3.jump import main as jump_Ther
    if request.method == 'POST':
        id = id
        user = request.user
        difficulty = difficulty
...
def walkstraight_therapist_view(request, difficulty, frequency,id):
    from pythonProject3.walkstraight import main as walkstraight_Ther
    if request.method == 'POST':
        id = id
        user = request.user
        difficulty = difficulty
